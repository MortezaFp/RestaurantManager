...
{
    public partial class RestaurantManager : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerMobileNumber = table.Column<string>(type: "varchar(11)", unicode: false, maxLength: 11, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Map_Orders_Adjustments", x => new { x.OrderId, x.AdjustmentId });
                    table.ForeignKey(
                        name: "FK_Map_Orders_Adjustments_Adjustments",
                        column: x => x.AdjustmentId,
                        principalTable: "Adjustments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Map_Orders_Adjustments_Orders",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Map_Orders_Adjustments_AdjustmentId",
                table: "Map_Orders_Adjustments",
                column: "AdjustmentId");
